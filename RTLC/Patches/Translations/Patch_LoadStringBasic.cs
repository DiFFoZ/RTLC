...
internal static class Patch_LoadStringBasic
{
    ...
    public static IEnumerable<MethodBase> EnumeratePatchingMethods()
    {
        ...
        yield return AccessTools.Method(typeof(ShipBuildModeManager), nameof(ShipBuildModeManager.CreateGhostObjectAndHighlight));
        ...
        yield return AccessTools.Method(typeof(HUDManager), nameof(HUDManager.DisplayCreditsEarning));
